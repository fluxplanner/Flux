...
Migrations `20260528300000_ia_east_staff_pilot.sql`, `20260528700000_ia_east_pilot_extended.sql`, and `20260529100000_ia_east_syllabus_conflict.sql` enable staff suite, locale, ops health, and student syllabus conflicts for `user_roles.school = International Academy East` via `flux_school_feature_flags`.  
