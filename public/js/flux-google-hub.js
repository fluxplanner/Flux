...
(function () {
  ...
  /** The workspace label was hardcoded to "Bloomfield", so staff at every other
   *  school were invited to connect a district they don't belong to. Use the
   *  school on the profile when we know it, and stay generic when we don't. */
  ...
  function staffHubMountHtml() {
    ...
    if (linked) {
      ...
      <div class="staff-google-hub staff-google-hub--connected">
        <h4 class="staff-google-hub-title">${ws} Workspace connected</h4>
    ...
    <div class="staff-google-hub staff-google-hub--gate">
      <h4 class="staff-google-hub-title">Connect ${ws} Workspace</h4>
      <p class="staff-google-hub-sub">Link Google Classroom and Drive alongside Gmail and Calendar — pop-up sign-in only; student flows stay separate.</p>
