...
(function () {
  ...
  const STEPS = [
    ...
    { sel: '.flg--functions .flg-items', title: 'Type an equation',
      body: 'Try y = x², sin(x), x = 3 or a point like (2, 5). Letters such as a or k become sliders you can drag — or press ▶ to animate.' },
    ...
    { sel: '.flg--data .flg-tfoot', title: 'What gets plotted',
      body: 'Choose which column goes on x and which on y, pick a line of best fit, and switch on max/min for the steepest and shallowest lines through the error bars.' },
    ...
    { sel: '#ghPng', title: 'For your report',
      body: 'Download a clean image on a white background, with a key that includes the fitted equation.' },
