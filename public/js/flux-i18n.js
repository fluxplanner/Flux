...
(function () {
  ...
  const UI_STRINGS = {
    ...
    'snip.paste_hint': 'Copy a screenshot, then paste here or tap',
    ...
    'auto.hook_focus_desc': 'Opens the Time tab and starts the pomodoro.',
    'auto.hook_timer': 'Time tab',
    ...
    'dash.section.countdown': 'Countdown (top bar)',
  ...
  const STRINGS = {
    ...
    'es-US': {
      ...
      'dash.section.countdown': 'Cuenta regresiva (barra superior)',
    ...
    'fr-FR': {
      ...
      'dash.section.countdown': 'Compte à rebours (barre du haut)',
