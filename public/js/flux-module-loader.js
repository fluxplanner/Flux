...
(function () {
  ...
  const CATALOG = [
    ...
    { id: 'classroom_hall_pass', flag: 'enable_classroom_tools', roles: ['teacher'], scope: 'work', title: 'Hall pass registry', status: 'planned', module: 'FluxClassroomTools' },
    { id: 'classroom_exit_ticket', flag: 'enable_classroom_tools', roles: ['teacher'], scope: 'work', title: 'Exit ticket generator', status: 'planned', module: 'FluxClassroomTools' },
    ...
    { id: 'classroom_oops_broadcast', flag: 'enable_classroom_tools', roles: ['teacher'], scope: 'work', title: 'Oops broadcast', status: 'planned', module: 'FluxClassroomTools' },
    { id: 'admin_duty_alerts', flag: 'enable_school_ops', roles: ['admin', 'staff'], scope: 'work', title: 'Duty roster alerts', status: 'planned', module: 'FluxSchoolOps' },
    { id: 'admin_sub_swap', flag: 'enable_school_ops', roles: ['admin', 'staff'], scope: 'work', title: 'Sub-coverage swap', status: 'planned', module: 'FluxStaffTabs' },
  ...
  function visibleModules(panelId) {
    ...
    return CATALOG.filter((m) => {
      ...
      if (!m.roles.includes(role) && !(role === 'admin' && m.roles.includes('staff'))) return false;
